...
if strcmp(cfg_run.mode, 'time_diversity_tau48_sixline')
    manifest.runner_version = 'time-diversity-20260718.11';
else
    manifest.runner_version = 'time-diversity-20260718.10';
end
