...
switch mode
    ...
    case "iso_gabp_adaptive"
        ...
        % Each scheme x CSI curve stops independently after at least 10
        ...
        cfg_run.iso_gabp = struct( ...
            'runner_version', 'iso-gabp-adaptive-20260723.1', ...
            'scientific_label', 'candidate', ...
            'assets', struct( ...
                'active_run_id_file', '_ACTIVE_ISO_GABP_SWEEP_ID.txt', ...
